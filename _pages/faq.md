...
[/vc_column_text][/vc_tta_section][/vc_tta_accordion][vc_custom_heading text="Pricing" font_container="tag:h5|font_size:18|text_align:left" use_theme_fonts="yes" css=".vc_custom_1541759143860{margin-bottom: 14px !important;}"][vc_tta_accordion][vc_tta_section title="Is there a custom fee exemptions for item/s worth 10,000 and below?" tab_id="1541759157263-815b504d-71aa"][vc_column_text]Yes, there's an exemption of customs fees for imported goods worth 10,000 and below. You can try it, however, the cons are:
